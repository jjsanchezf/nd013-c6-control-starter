...
//first
//pid_steer.Init(0.289, 0.009, 0.399, 1.2, -1.2);
//  pid_throttle.Init(0.349, 0.009, 0.199, 1.0, -1.0);

//second
//pid_steer.Init(0.2, 0.04, 2,1.2,-1.2);
//pid_throttle.Init(0.2, 0.04, 2,1,-1);

//third
  pid_steer.Init(-0.05, 0.001, 2.1,1.2,-1.2);
  pid_throttle.Init(0.5, 0.00024, 1.1,1,-1);
  ...
  h.onMessage([&pid_steer, &pid_throttle, &new_delta_time, &timer, &prev_timer, &i, &prev_timer](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode)
  {
        ...
        if (s != "") {
          ...
          **/
          error_steer = 0;
          double desired_angle=angle_between_points(x_points[0], y_points[0], x_points[1], y_points[1]);
          error_steer= yaw  - desired_angle;
